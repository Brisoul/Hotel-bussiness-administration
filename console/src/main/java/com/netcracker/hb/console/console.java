...
//        mari.setRooms(room300);
        ...
        FileOutputStream outputStream = new FileOutputStream("D:\\projects\\Project-Hotel-Administration\\entSAVE\\hotel_entities\\UUID-hotel.txt");
